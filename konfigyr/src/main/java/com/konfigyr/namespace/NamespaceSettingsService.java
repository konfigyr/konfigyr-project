...
class NamespaceSettingsService {
	...
	void name(String namespace, String name) {
	...
	@Transactional
	@CacheEvict(value = DefaultNamespaceManager.CACHE_NAME, key = "#namespace")
	void slug(String namespace, Slug slug) {
		Assert.notNull(namespace, "Namespace identifier can not be null");
	...
	@Transactional
	@CacheEvict(value = DefaultNamespaceManager.CACHE_NAME, key = "#namespace")
	void description(String namespace, String description) {
		Assert.notNull(namespace, "Namespace identifier can not be null");
		Assert.notNull(namespace, "Namespace identifier can not be null");
