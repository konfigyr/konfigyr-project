...
@SpringBootTest(
		classes = CryptographyIntegrationTest.Configuration.class,
		properties = "spring.cache.type=caffeine"
)
public class CryptographyIntegrationTest extends AbstractIntegrationTest {
