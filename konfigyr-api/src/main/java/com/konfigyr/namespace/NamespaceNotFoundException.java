...
public class NamespaceNotFoundException extends NamespaceException {
	...
	public NamespaceNotFoundException(@NonNull String slug) {
		super(HttpStatus.NOT_FOUND, "Could not find a namespace with the following name: " + slug);
	}
	...
	public NamespaceNotFoundException(@NonNull EntityId id) {
		super(HttpStatus.NOT_FOUND, "Could not find a namespace with the following identifier: " + id.serialize());
	}
