...
/**
 * Implementation of the {@link SearchQuery}, {@link SearchQuery.Criteria} and {@link SearchQuery.Builder}
 * interfaces.
 *
...
final class CriteriaSearchQuery implements SearchQuery {
	...
	record SearchQueryCriteria<T>(String name, Class<T> type) implements SearchQuery.Criteria<T> {
		@Serial
		private static final long serialVersionUID = -2088301892487492935L;
	}

	static final class SearchQueryBuilder implements SearchQuery.Builder {
