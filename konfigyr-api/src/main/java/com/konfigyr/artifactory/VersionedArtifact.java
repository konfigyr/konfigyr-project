...
public record VersionedArtifact (
	...
	public static final class Builder {
		...
		/**
		 * Specify the internal {@link EntityId} for the {@link Artifact} that owns this {@link VersionedArtifact}.
		 *
		...
		/**
		 * Specify the external {@link EntityId} for the {@link Artifact} that owns this {@link VersionedArtifact}.
		 *
		...
		/**
		 * Specify the {@link EntityId} for the {@link Artifact} that owns this {@link VersionedArtifact}.
		 *
		...
		public Builder version(String version) {
			return version(version == null ? null : Version.of(version));
		}
		...
		public VersionedArtifact build() {
			...
			return new VersionedArtifact(id, artifact, groupId, artifactId, version, checksum, name,
