...
export function DialogContent({
  ...
  closeLabel = 'Close',
  ...props
}: DialogPrimitive.Popup.Props & { showCloseButton?: boolean, closeLabel?: ReactNode }) {
  return (
    <DialogPortal>
      <DialogOverlay>
...
export function DialogFooter({
  ...
  children,
  ...props
}: React.ComponentProps<'div'> & { showCloseButton?: boolean, closeLabel?: ReactNode }) {
  return (
    <div
    ...
    >
      {children}
      {showCloseButton && (
        <DialogClose render={<Button variant="outline">{closeLabel}</Button>} />
      )}
    </div>
  );
}
