...
import { Spinner } from '@konfigyr/ui/components/spinner';
import { cn } from '@konfigyr/ui/lib/utils';

export type { ToastManagerAddOptions } from '@base-ui/react/toast';
...
export function ToastTitle({ className, ...props }: ToastPrimitive.Title.Props) {
  return (
    <ToastPrimitive.Title
      ...
      className={cn('text-sm font-heading font-semibold leading-relaxed', className)}
      {...props}
    />
  );
}
...
export function ToastAction({ className, render = <Button variant="outline" size="sm" />, ...props }: ToastPrimitive.Action.Props) {
  return (
