...
export function Input({ className, type = 'text', ...props }: React.ComponentProps<typeof InputPrimitive>) {
  return (
    <InputPrimitive
      type={type}
      data-slot="input"
      className={cn(
        ...
        'disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-(--input-disabled-bg) disabled:text-(--input-disabled-text)',
