 ...
 * @param recipient  email address of the user that is requested to join the namespace, can't be {@literal null}
...
public record Invitation(
	...
	public static final class Builder {
		...
		/**
		 * The email address of the recipient of this {@link Invitation}.
		 *
		 * @param recipient invitation recipient email address
		 * @return invitation builder
		 */
		@NonNull
		...
		public Invitation build() {
			...
			Assert.hasText(recipient, "Recipient email address can not be blank");
			Assert.notNull(recipient, "Namespace member role can not be null");
