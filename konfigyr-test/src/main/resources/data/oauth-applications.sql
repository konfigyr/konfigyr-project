...
(4, 1, 'Shop app', 'kfg-BAQp6u2ElYmuPyoa2Hj766ju0PPvL2Iq', '{argon2}$argon2id$v=19$m=19456,t=2,p=1$cr2XXN6S6e4WyFEF5JEBjA$pfEzX0qjdaL7kz+4VhT0iySuSVFDKqgidCBNS2zmJo4', 'profiles:read', NULL, now() - interval '2 days', now() - interval '2 days');
