 ...
 **/
public class KonfigyrMethodSecurityExpressionHandler extends DefaultMethodSecurityExpressionHandler {

	@Override
	public EvaluationContext createEvaluationContext(Supplier<Authentication> authentication, MethodInvocation mi) {
		final KonfigyrMethodSecurityExpressionRoot root = new KonfigyrMethodSecurityExpressionRoot(authentication);
